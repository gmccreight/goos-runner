...
--
-- Host: localhost    Database: openfire_dev
-- ------------------------------------------------------
...
INSERT INTO `ofID` VALUES (18,1),(19,1),(23,1),(25,2),(26,2);
...
INSERT INTO `ofProperty` VALUES ('passwordKey','x739Ki9fQKAPg9C'),('provider.admin.className','org.jivesoftware.openfire.admin.DefaultAdminProvider'),('provider.auth.className','org.jivesoftware.openfire.auth.DefaultAuthProvider'),('provider.group.className','org.jivesoftware.openfire.group.DefaultGroupProvider'),('provider.lockout.className','org.jivesoftware.openfire.lockout.DefaultLockOutProvider'),('provider.securityAudit.className','org.jivesoftware.openfire.security.DefaultSecurityAuditProvider'),('provider.user.className','org.jivesoftware.openfire.user.DefaultUserProvider'),('provider.vcard.className','org.jivesoftware.openfire.vcard.DefaultVCardProvider'),('update.lastCheck','1407110200947'),('xmpp.auth.anonymous','true'),('xmpp.domain','vagrant-ubuntu-trusty-64'),('xmpp.session.conflict-limit','0'),('xmpp.socket.ssl.active','true');
...
INSERT INTO `ofPubsubAffiliation` VALUES ('pubsub','','vagrant-ubuntu-trusty-64','owner');
...
INSERT INTO `ofPubsubNode` VALUES ('pubsub','',0,'001407110160074','001407110160074',NULL,0,0,0,0,1,1,1,0,0,'publishers',1,0,'open','','','','vagrant-ubuntu-trusty-64','','English','',NULL,'all',-1);
...
INSERT INTO `ofSecurityAuditLog` VALUES (1,'admin',1407110252501,'created new user auction-item-54321','vagrant-ubuntu-trusty-64','name = null, email = null, admin = false');
...
INSERT INTO `ofUser` VALUES ('admin',NULL,'d77dfbc6e72798411456853e891987c5815639a45a1a5a5eaa9db99938633db2','Administrator','admin@example.com','001407110155545','0'),('auction-item-54321',NULL,'1aa67a4578b4d0e2f94fec2b95012838fcf547e61dec26f5',NULL,NULL,'001407110252464','001407110252464');
...
-- Dump completed on 2014-08-03 23:57:37
